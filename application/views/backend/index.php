                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td align="center">
                                                <a href="<?php echo base_url()."admin/admin/do_edit/".$d['id_order']; ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-edit "></i> Edit</button>
                                                <a href="<?php echo base_url()."admin/admin/do_delete/".$d['id_order']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
                                        <?php 
                                            $nomor = $nomor+1; } ?>

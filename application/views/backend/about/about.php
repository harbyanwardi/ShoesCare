           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li  >
                        <a class="active-menu" href="<?php echo base_url('admin/C_about') ?>"><i class="fa fa-edit fa-3x"></i> Tentang Kami</a>
                    </li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td align="center">
                                                <a href="<?php echo base_url()."admin/C_about/do_edit/".$d['id']; ?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button>

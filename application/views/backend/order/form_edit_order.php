           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <li>
                        <a class="active-menu" href="<?php echo base_url('admin/Admin') ?>"><i class="fa fa-dashboard fa-3x"></i> Data Order Online</a>
                    </li>
                    <li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Features</h3>
                                    <form role="form" method="POST" action="<?php echo base_url('admin/Admin/do_update') ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="merk_sepatu" value="<?php echo $merk_sepatu; ?>" />
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Size Sepatu</label>
                                            <input class="form-control" name="size_sepatu" value="<?php echo $size_sepatu; ?>" />
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Keterangan Sepatu</label>
                                            <input class="form-control" name="ket_sepatu" value="<?php echo $ket_sepatu; ?>" />
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Jenis Layanan</label>
                                            <input class="form-control" name="jenis_layanan" value="<?php echo $jenis_layanan; ?>" />
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select class="form-control" name="status">
                                                ...
                                                <option value="PROSES ANTAR">PROSES ANTAR</option>

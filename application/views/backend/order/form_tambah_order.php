            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <li>
                    ...
                    <li  >
                        <a chref="<?php echo base_url('admin/C_about') ?>"><i class="fa fa-edit fa-3x"></i> Tentang Kami</a>
                    </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>DATA ORDER</h3>
                                    <form role="form" method="POST" action="<?php echo base_url('admin/Admin/do_insert') ?>">
                                        <div class="form-group">
                                            <label>Nama Account</label>
                                            <input class="form-control" name="nama_account" />

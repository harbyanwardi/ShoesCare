                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>ACCOUNT</h3>
                                    <form action="<?php echo base_url('admin/C_Account/do_insert') ?>" method="POST" enctype="multipart/form-data">
                                    <form role="form">
                                        
                                        
                                        <div class="form-group">
                                            <label>Nama Lengkap</label>
                                            <input name="nama_account" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="email_pengguna" class="form-control" />
                                            
                                        </div>

                                        <div class="form-group">
                                            <label>Alamat Pengguna</label>
                                            <input name="alamat_pengguna" class="form-control" />

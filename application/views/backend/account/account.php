                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo base_url('admin/C_Account/add')?>"><button class="btn btn-success" style="margin-bottom: 10px;">TAMBAH</button></a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                       <?php
                                        ...
                                        <tr class="odd gradeX">
                                            <td>
                                                <img src="<?php echo base_url().'assets/backend/uploads/image_resize/account/'.$show['foto_profil'] ?>">
                                            </td>
                                            
                                            <td align="center"><?php echo $show['nama_account']?></td>
                                            <td align="center"><?php echo $show['username']?></td>
                                            <td align="center"><?php echo $show['password']?></td>
                                            
                                            <td align="center"><?php echo $show['no_telp']?></td>
                                            <td align="center"><?php echo $show['email_pengguna']?></td>
                                            <td align="center" >
                                                <a href="<?php echo base_url()."admin/C_Account/do_edit/".$show['id']; ?>"><button class="btn btn-primary btn-sm" style="margin-bottom: 5px;">EDIT</button></a>
                                                <a href="<?php echo base_url()."admin/C_Account/do_delete/".$show['id']; ?>"><button class="btn btn-danger btn-sm" style="margin-bottom: 5px;">DELETE</button></a>
                                            </td>

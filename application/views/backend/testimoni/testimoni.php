            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li  >
                     ...
                     <li  >
                        <a class="active-menu" href="<?php echo base_url('admin/C_testimoni') ?>"><i class="fa fa-comments fa-3x"></i> Testimoni</a>
                    </li>
                    <li  >
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?=$this->session->flashdata('pesan')?>
                                <a href="<?php echo base_url('admin/C_testimoni/add')?>"><button class="btn btn-success" style="margin-bottom: 10px;">TAMBAH</button></a>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $show['deskripsi_testimoni']?></td>
                                            </td>
                                            <td align="center">
                                                <a href="<?php echo base_url()."admin/C_testimoni/do_edit/".$show['id']; ?>"><button class="btn btn-primary" style="margin-bottom: 5px;">EDIT</button></a>
                                                <a href="<?php echo base_url()."admin/C_testimoni/do_delete/".$show['id']; ?>"><button class="btn btn-danger" style="margin-bottom: 5px;">DELETE</button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

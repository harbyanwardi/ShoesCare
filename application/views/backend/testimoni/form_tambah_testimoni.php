                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>TESTIMONI</h3>
                                    <form action="<?php echo base_url('admin/C_testimoni/do_insert') ?>" method="POST" enctype="multipart/form-data">
                                    <form role="form">
                                        <div class="form-group">
                                            <label>Id Pengguna</label>
                                            <input name="id_ac" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="deskripsi_testimoni"></textarea>

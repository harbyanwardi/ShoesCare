                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>TESTIMONI</h3>
                                    <form action="<?php echo base_url('admin/C_testimoni/do_update') ?>" method="POST" enctype="multipart/form-data">
                                   
                                        <div class="form-group">
                                            <label>Id Pengguna</label>
                                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                                            <input name="id_ac" class="form-control"  value="<?php echo $id_ac; ?>"  />
                                         </div>   
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="deskripsi_testimoni" ><?php echo $deskripsi_testimoni; ?></textarea>

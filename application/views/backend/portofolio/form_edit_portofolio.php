                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>PORTOFOLIO</h3>
                                    <form action="<?php echo base_url('admin/C_portofolio/do_update') ?>" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Nama Kegiatan</label>
                                            <input type="hidden" name="id_portofolio" value="<?php echo $id_portofolio; ?>">
                                            <input name="nama_kegiatan" class="form-control"  value="<?php echo $nama_kegiatan; ?>"  />
                                         </div>   
                                        <div class="form-group">
                                            <label>Deskripsi</label>
                                            <input name="deskripsi" class="form-control"  value="<?php echo $deskripsi; ?>" />
                                        </div>
                                        <div class="form-group" <img src="<?php echo base_url('assets/uploads/image_resize/portofolio/')?>">
                                            
                                            <label>File input</label>
                                            <input type="file" name="gambar" value="upload"/>
                                        </div>

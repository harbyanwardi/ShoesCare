                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo base_url('admin/C_portofolio/add')?>"><button class="btn btn-success" style="margin-bottom: 10px;">TAMBAH</button></a>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                             <img src="<?php echo base_url().'assets/backend/uploads/image_resize/portofolio/'.$show['gambar'] ?>">
                                        </td>
                                            </td>
                                            <td align="center">
                                                <a href="<?php echo base_url()."admin/C_portofolio/do_edit/".$show['id_portofolio']; ?>"><button class="btn btn-primary" style="margin-bottom: 5px;">EDIT</button></a>
                                                <a href="<?php echo base_url()."admin/C_portofolio/do_delete/".$show['id_portofolio']; ?>"><button class="btn btn-danger" style="margin-bottom: 5px;">DELETE</button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>

                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>LAYANAN</h3>
                                    <form action="<?php echo base_url('admin/C_services/do_update') ?>" method="POST" enctype="multipart/form-data">
                                   
                                        <div class="form-group">
                                            <label>Jenis Layanan</label>
                                            <input type="hidden" name="id_services" value="<?php echo $id_services; ?>">
                                            <input name="jenis_layanan" class="form-control"  value="<?php echo $jenis_layanan; ?>"  />
                                         </div> 

                                         <div class="form-group">
                                            <label>icon</label>
                                            <input name="icon" class="form-control" value="<?php echo $icon; ?>" />

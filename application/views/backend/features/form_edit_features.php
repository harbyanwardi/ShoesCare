                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Features</h3>
                                    <form role="form" method="POST" action="<?php echo base_url('admin/C_features/do_update') ?>">
                                        <div class="form-group">
                                            <label>Nama Features</label>
                                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                                            <input class="form-control" name="nama_features" value="<?php echo $nama_features; ?>"  />

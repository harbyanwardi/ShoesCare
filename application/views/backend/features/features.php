            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <li>
                    ...
                    <li  >
                        <a class="active-menu"  href="<?php echo base_url('admin/C_features') ?>"><i class="fa fa-table fa-3x"></i> Fitur</a>
                    </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <a href="<?php echo base_url('admin/C_features/add')?>"><button class="btn btn-success" style="margin-bottom: 10px;">TAMBAH</button></a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <td><?php echo $d['nama_features']; ?></td>
                                            <td><?php echo $d['deskripsi']; ?></td>
                                            <td align="center">
                                                <a href="<?php echo base_url()."admin/C_features/do_edit/".$d['id']; ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-edit "></i> Edit</button>
                                                <a href="<?php echo base_url()."admin/C_features/do_delete/".$d['id']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
